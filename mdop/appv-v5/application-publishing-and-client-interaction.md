...
Per modificare il percorso predefinito dell'archivio pacchetti durante l'installazione, vedi [Come distribuire il client App-V.](how-to-deploy-the-app-v-client-gb18030.md)
