...
Usare le informazioni in questo articolo per usare Microsoft Application Virtualization 5,0 o versioni successive per offrire Microsoft Office 2016 come applicazione virtualizzata ai computer dell'organizzazione. Per informazioni sull'uso di App-V per consegnare Office 2013, vedere [distribuzione di Microsoft office 2013 tramite App-v](deploying-microsoft-office-2013-by-using-app-v.md). Per informazioni sull'uso di App-V per consegnare Office 2010, vedere [distribuzione di Microsoft office 2010 tramite App-v](deploying-microsoft-office-2010-by-using-app-v.md).
...
Completare la procedura seguente per creare un pacchetto di Office 2016 per App-V 5,0 o versioni successive.

>**Important** &nbsp; Importante &nbsp; In App-V 5,0 e versioni successive è necessario usare lo strumento di distribuzione di Office per creare un pacchetto. Non è possibile usare il sequencer per creare pacchetti.
...
1. **Personalizzare il file di configurazione XML di esempio:** Usare il file di configurazione XML di esempio scaricato con lo strumento di distribuzione di Office per personalizzare le applicazioni di Office:
   ...
   2. Con l'esempio configuration.xml file aperto e pronto per la modifica, è possibile specificare i prodotti, le lingue e il percorso in cui si salvano le applicazioni di Office 2016. Di seguito è riportato un esempio di base del file configuration.xml:
      ...
      <tr class="even">
      <td align="left"><p>Channel (attributo di Add Element)</p></td>
      <td align="left"><p>Facoltativo. Specifica il canale di aggiornamento per il prodotto che si vuole scaricare o installare. </p><p>Per altre informazioni sui canali di aggiornamento, vedere Panoramica dei canali di aggiornamento per le app Microsoft 365 per le aziende.</p></td>
