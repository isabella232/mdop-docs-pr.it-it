...
Usare le informazioni seguenti per pianificare la distribuzione di Office tramite App-V. Questo articolo include:
...
Nella tabella seguente sono elencate le versioni di Microsoft Office supportate da App-V, i metodi di creazione di pacchetti di Office, le licenze supportate e le distribuzioni supportate.
...
<thead>
<tr class="header">
<th align="left">Versione di Office supportata</th>
<th align="left">Versioni App-V supportate</th>
<th align="left">Creazione di pacchetti</th>
<th align="left">Licenze supportate</th>
<th align="left">Distribuzioni supportate</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><p>App Microsoft 365 per le aziende</p>
<p>Supportato anche:</p>
<ul>
...
<td align="left"><p>Strumento di distribuzione di Office</p></td>
<td align="left"><p>Sottoscrizione</p></td>
<td align="left"><ul>
<li><p>Desktop</p></li>
<li><p>VDI personale</p></li>
<li><p>VDI in pool</p></li>
<li><p>RDS</p></li>
</ul></td>
</tr>
<tr class="even">
...
È possibile installare più di una versione di Microsoft Office affiancata nello stesso computer usando "coesistenza di Microsoft Office". È possibile implementare la coesistenza di Office con le combinazioni di tutte le versioni principali di Office e con i metodi di installazione, se applicabile, usando la versione di Office basata su Windows Installer (MSi), a portata di clic e App-V 5,0 SP2. Tuttavia, l'uso della coesistenza di Office non è consigliato da Microsoft.
...
2.  Avviare l'editor del registro di sistema eseguendo le operazioni seguenti:
    ...
    -   In Windows 8 digitare **Regedit** premere INVIO nella pagina iniziale e quindi premere INVIO.
