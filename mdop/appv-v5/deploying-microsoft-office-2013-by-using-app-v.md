...
Usare le informazioni in questo articolo per usare Microsoft Application Virtualization 5,0 o versioni successive per offrire Microsoft Office 2013 come applicazione virtualizzata ai computer dell'organizzazione. Per informazioni sull'uso di App-V per consegnare Office 2010, vedere [distribuzione di Microsoft office 2010 tramite App-v](deploying-microsoft-office-2010-by-using-app-v.md). Per distribuire correttamente Office 2013 con App-V, è necessario avere familiarità con Office 2013 e PP-V.
...
-   [Pubblicazione del pacchetto di Office per App-V 5,0](#bkmk-pub-pkg-office)
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="planning-for-using-app-v-with-office.md#bkmk-office-vers-supp-appv" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office.md#bkmk-office-vers-supp-appv)">Pianificazione per l'uso di App-V con Office</a></p></td>
<td align="left"><ul>
...
<tr class="even">
<td align="left"><p><a href="planning-for-using-app-v-with-office.md#bkmk-plan-coexisting" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office.md#bkmk-plan-coexisting)">Pianificazione per l'uso di App-V con Office</a></p></td>
...
<li><p>In App-V 5,0 e versioni successive è necessario usare lo strumento di distribuzione di Office per creare pacchetti. Non è possibile usare il sequencer.</p></li>
...
Completare la procedura seguente per creare un pacchetto di Office 2013 per App-V 5,0 o versioni successive.

**Importante**  
In App-V 5,0 e versioni successive è necessario lo strumento di distribuzione di Office per creare un pacchetto. Non è possibile usare il sequencer per creare pacchetti.
...
<td align="left"><ul>
<li><p>versione di Windows 8 a 64 bit</p></li>
...
Creare pacchetti di Office 2013 App-V in computer Windows a 64 bit. Una volta creato, il pacchetto di Office 2013 App-V verrà eseguito in computer con Windows 7 e Windows 8 a 32 bit e 64 bit.
...
1. **Personalizzare il file di configurazione XML di esempio:** Usare il file di configurazione XML di esempio scaricato con lo strumento di distribuzione di Office per personalizzare le applicazioni di Office:
   ...
   2. Con l'esempio configuration.xml file aperto e pronto per la modifica, è possibile specificare i prodotti, le lingue e il percorso in cui si salvano le applicazioni di Office 2013. Di seguito è riportato un esempio di base del file configuration.xml:
      ...
      **Nota**  
      ...
      Il file di configurazione XML precedente specifica che Office 2013 ProPlus 32 bit Edition, incluso Visio ProPlus, verrà scaricato in inglese in \\\\server\\Office 2013, che rappresenta il percorso in cui verranno salvate le applicazioni di Office. Si noti che l'ID prodotto delle applicazioni non influirà sulla licenza finale di Office. I pacchetti App-V di Office 2013 con varie licenze possono essere creati dalle stesse applicazioni specificando le licenze in una fase successiva. Nella tabella seguente sono riepilogati gli attributi e gli elementi personalizzabili del file XML:
      ...
      <td align="left"><p>Specifica l'edizione del prodotto Office 2013 da usare: 32 bit o 64 bit. L'operazione non riesce se <strong> OfficeClientEdition </strong> non è impostato su un valore valido.</p></td>
      ...
      <td align="left"><p>Specifica l'applicazione. Project 2013 e Visio 2013 devono essere specificati qui come prodotto aggiunto da includere nelle applicazioni.</p></td>
      ...
      Dopo aver modificato il file configuration.xml per specificare il prodotto desiderato, le lingue e anche la posizione in cui verranno salvate le applicazioni di Office 2013, è possibile salvare il file di configurazione, ad esempio come Customconfig.xml.
...
-   Creare i pacchetti App-V di Office 2013 nei computer Windows a 64 bit. Tuttavia, il pacchetto verrà eseguito nei computer con Windows 7 e Windows 8 a 32 bit e 64.
...
## <a href="" id="bkmk-pub-pkg-office"></a>Pubblicazione del pacchetto di Office per App-V 5,0
...
2.  Sequenziare i plug-in usando l'App-V 5,0 sequencer. Assicurarsi che Office 2013 sia installato nel computer usato per sequenziare il plug-in. È consigliabile usare le app Microsoft 365 per le aziende (non virtuali) nel computer di sequenziazione quando si sequenziano i plug-in di Office 2013.

3.  Crea un pacchetto di App-V 5,0 che include i plug-in desiderati.
