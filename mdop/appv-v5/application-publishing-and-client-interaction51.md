...
Per informazioni sulla sequenziazione, vedere [Guida alla sequenziazione della virtualizzazione delle applicazioni](https://go.microsoft.com/fwlink/?LinkID=269810).
...
Per modificare la posizione predefinita dell'archivio pacchetti durante l'installazione, vedere [come distribuire il client App-V](how-to-deploy-the-app-v-client-51gb18030.md).
...
<td align="left"><p>In Windows 8 e versioni successive, consente lo streaming su reti 3G e cellulari</p></td>
</tr>
<tr class="even">
...
App-V 5,1 supporta il reindirizzamento delle cartelle della cartella AppData Roaming (% AppData%). Quando l'ambiente virtuale viene avviato, lo stato di AppData Roaming dalla directory AppData Roaming dell'utente viene copiato nella cache locale. Viceversa, quando l'ambiente virtuale viene arrestato, la cache locale associata al AppData Roaming di un utente specifico viene trasferita nella posizione effettiva della directory AppData Roaming di tale utente.
