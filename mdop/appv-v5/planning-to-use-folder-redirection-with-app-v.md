...
App-V 5,0 SP2 supporta l'uso del reindirizzamento delle cartelle, una funzionalità che consente agli utenti e agli amministratori di reindirizzare il percorso di una cartella in una nuova posizione.
...
<p>Per ottenere la ridondanza, App-V 5,0 mantiene le tre copie più recenti dei dati compressi in% AppData%.</p></td>
</tr>
</tbody>
</table>
