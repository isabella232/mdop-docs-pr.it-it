...
---
# Come distribuire il server App-V 5.0


Usare la procedura seguente per installare il server App-V 5,0. Per informazioni sulla distribuzione del server App-V 5,0 SP3, vedere [informazioni su App-v 5,0 SP3](about-app-v-50-sp3.md#bkmk-migrate-to-50sp3).

**Prima di iniziare:**

-   Verificare di aver installato il software prerequisito. Vedere [prerequisiti di App-V 5,0](app-v-50-prerequisites.md).

-   Esaminare la sezione server delle [considerazioni sulla sicurezza di App-V 5,0](app-v-50-security-considerations.md).
...
4. Nella pagina **Selezione funzionalità** selezionare tutti i componenti seguenti.
   ...
   <td align="left"><p>Fornisce l'App-V 5,0 Reporting Services.</p></td>
   </tr>
   <tr class="odd">
