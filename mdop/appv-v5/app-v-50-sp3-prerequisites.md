...
---
# Prerequisiti di App-V 5.0 SP3


Prima di installare Microsoft Application Virtualization (App-V) 5,0 SP3, verificare di avere installato tutti i seguenti requisiti software necessari.

Per un elenco dei requisiti hardware e sistemi operativi supportati per App-V Server, sequencer e client, Vedi [configurazioni supportate in App-v 5,0 SP3](app-v-50-sp3-supported-configurations.md).
...
Installare il software prerequisito necessario per i componenti del server App-V 5,0 SP3.
...
<td align="left"><ul>
<li><p>Installazione dell'App-V Server in un computer che esegue qualsiasi versione o componente precedente di App-V.</p></li>
...
<td align="left"><p>Per le versioni supportate, vedere <a href="app-v-50-sp3-supported-configurations.md" data-raw-source="[App-V 5.0 SP3 Supported Configurations](app-v-50-sp3-supported-configurations.md)"> configurazioni supportate in App-V 5,0 SP3 </a> .</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>La console di gestione è disponibile solo se è installato Silverlight.</p></td>
</tr>
</tbody>
</table>
...
Il database di gestione è obbligatorio solo se si usa il server di gestione di App-V 5,0 SP3.
...
Il database delle relazioni è obbligatorio solo se si usa il server di report App-V 5,0 SP3.
...
-   Il processo di sequenziazione è intensivo delle risorse, quindi assicurati che il computer che esegue il sequencer abbia abbondanza di memoria, un processore veloce e un disco rigido veloce. I requisiti di sistema delle applicazioni installate localmente non possono superare quelli del sequencer. Per altre informazioni, Vedi [configurazioni supportate in App-V 5,0](app-v-50-supported-configurations.md).
