...
-   Verificare di aver installato Microsoft Application Virtualization (App-V) Sequencer, che è necessario per la modifica di un pacchetto di applicazione virtuale. Per installare l'App-V Sequencer, vedere [come installare il sequencer](how-to-install-the-sequencer-beta-gb18030.md).
