...
Puoi creare l'immagine di ripristino di Microsoft Diagnostics and Recovery Toolset (DaRT) 10 usando uno script di PowerShell invece di usare la creazione guidata immagine di ripristino di DaRT 10. Vedere lo script di esempio seguente.
