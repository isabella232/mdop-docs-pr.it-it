...
---
# Note sulla versione di Microsoft User Experience Virtualization (UE-V) 2.1
...
## Aggiornamenti rapidi e articoli della Knowledge base per UE-V 2,1


Questa sezione contiene gli hotfix e gli articoli della KB per la versione UE-V 2,1.
