...
ms.locfileid: "10822886"
---
# <span data-ttu-id="4c239-103">Come usare uno script di PowerShell per creare l'immagine di ripristino</span><span class="sxs-lookup"><span data-stu-id="4c239-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="4c239-104">Per creare l'immagine di ripristino delle freccette usando uno script di PowerShell</span><span class="sxs-lookup"><span data-stu-id="4c239-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="4c239-105">Puoi creare l'immagine di ripristino di Microsoft Diagnostics and Recovery Toolset (DaRT) 8,0 usando uno script di PowerShell invece di usare la creazione guidata immagine di ripristino di DaRT 8,0.</span><span class="sxs-lookup"><span data-stu-id="4c239-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="4c239-106">Vedere lo script di esempio seguente.</span><span class="sxs-lookup"><span data-stu-id="4c239-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="4c239-107">Ho</span><span class="sxs-lookup"><span data-stu-id="4c239-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="4c239-108">Argomenti correlati</span><span class="sxs-lookup"><span data-stu-id="4c239-108">Related topics</span></span>


[<span data-ttu-id="4c239-109">Amministrazione di DaRT 8.0 con PowerShell</span><span class="sxs-lookup"><span data-stu-id="4c239-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
