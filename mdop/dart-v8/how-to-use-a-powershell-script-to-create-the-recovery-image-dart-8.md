...
---
# Come usare uno script di PowerShell per creare l'immagine di ripristino


## <a href="" id="bkmk-create-image-use-script"></a>Per creare l'immagine di ripristino delle freccette usando uno script di PowerShell


Puoi creare l'immagine di ripristino di Microsoft Diagnostics and Recovery Toolset (DaRT) 8,0 usando uno script di PowerShell invece di usare la creazione guidata immagine di ripristino di DaRT 8,0. Vedere lo script di esempio seguente.
...
`Import-Module "Dism"`Ho`mport-Module "Microsoft.Dart"`
